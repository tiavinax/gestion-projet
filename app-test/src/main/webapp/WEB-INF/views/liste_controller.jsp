...
<%@ page import="java.util.List, mg.itu.framework.Controller, java.lang.reflect.Method" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
            ...
            <ul class="controller-list">
                <%
                    ...
                    for (Class<?> controller : controllers) {
                        ...
                        String annotationValue = (annotation != null && !annotation.value().isEmpty()) ? annotation.value() : controller.getSimpleName();
                %>
                    <li class="controller-item">
                        <div style="display: flex; align-items: center; gap: 15px; flex: 1;">
                            <span class="controller-number"><%= index++ %></span>
                            <div>
                                <div class="controller-name">
                                    <%= controller.getSimpleName() %>
                                    <span class="controller-annotation">@Controller("<%= annotationValue %>")</span>
                                </div>
        ...
        <div class="footer">
            ...
            <%= (controllers != null) ? controllers.size() : 0 %> contrôleur(s) chargé(s)
        </div>
    </div>
</body>
</html>