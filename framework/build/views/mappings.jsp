    ...
    <%@ page import="java.util.*, mg.itu.framework.MethodInfo" %>
        ...
        <body>
            <div class="container">
                ...
                <div class="info-bar">
                    <div>
                        <span> Total URLs : <strong>
                                <%= ((Map<String, MethodInfo>) request.getAttribute("urlMapping")).size() %>
                            </strong></span>
                        <span style="margin-left: 15px;"> Contrôleurs : <strong>
                ...
                <% String currentUrl=(String) request.getAttribute("currentUrl"); if (currentUrl !=null &&
                    !currentUrl.isEmpty()) { %>
                    ...
                    <% } %>
                        ...
                        <% Map<String, MethodInfo> urlMapping = (Map<String, MethodInfo>)
                                ...
                                <% } else { %>
                                    ...
                                    <ul class="url-list">
                                        <% int index=1; for (Map.Entry<String, MethodInfo> entry :
                                            urlMapping.entrySet()) {
                                            MethodInfo info = entry.getValue();
                                            %>
                                            <li class="url-item">
                                                <div style="display: flex; align-items: center; gap: 15px; flex: 1;">
                                                    <span class="url-number">
                                                        <%= index++ %>
                                                    </span>
                                                    <div>
                                                        <div class="url-path">
                                                        ...
                                                        <div>
                                                            <span class="url-controller">
                                                                <%= info.getControllerName() %>
                                                            </span>
                                                            <span style="color: #95a5a6;">.</span>
                                                            <span class="url-method">
                                                                <%= info.getMethodName() %>()
                                                            </span>
                                                        </div>
                                                    </div>
                                    ...
                                    <% } %>
                                        ...
                                        <div class="footer">
                                            <strong>Framework MVC Artisanal</strong> &bull; Sprint 2 - @RequestMapping
                                            &bull;
